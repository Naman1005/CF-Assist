...
**CF-Assist** is a modern, insight-driven dashboard for Codeforces competitive programmers. It goes beyond the standard profile page to give you actionable data-visualizing your rating progression, identifying your weakest problem tags, and helping you hunt for the perfect practice problems.
...
**CF-Assist** answers questions like:

- "Which algorithm tags do I fail the most?"
...
- **Rating Progression:** Interactive line charts to track your climb (or fall).
...
1. **Clone the repo**
   ...
   ```bash
   git clone https://github.com/naman1005/CF-Assist.git
   cd CF-Assist
   ```
...
Built with 💻 and ☕ by a fellow competitive programmer.
